...
public class NoticeAdapter extends BaseAdapter {
    ...
    public NoticeAdapter(Context context,Fragment fragment) {
...
//        communityItems.setNo(no);
//        communityItems.setUserNo(userNo);
//        communityItems.setProfile(profile);
//        communityItems.setName(name);
//        communityItems.setDate(date);
//        communityItems.setImgListPath(imgListPath);
//        communityItems.setContents(contents);
//        communityItems.setHashTag(hashTag);
//        communityItems.setLikeCnt(likeCnt);
//        communityItems.setCommentCnt(commentCnt);
