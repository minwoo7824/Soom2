package com.kmw.soom2.Activity;
...
public class TestActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        /*
         * 2015년 8월 이전에 등록하고 앱 정보 갱신을 안한 경우 기존에 설정해준 callback intentSnsSignupActivity url 을 넣어줘야 로그인하는데 문제가 안생긴다.
         * 2015년 8월 이후에 등록했거나 그 뒤에 앱 정보 갱신을 하면서 package name 을 넣어준 경우 callback intentSnsSignupActivity url 을 생략해도 된다.
         */
    ...
    public void onButtonClick(View v) throws Throwable {
        ...
        switch (v.getId()) {
            case R.id.buttonOAuth: {
                mOAuthLoginInstance.startOauthLoginActivity(TestActivity.this, mOAuthLoginHandler);
                break;
            }
