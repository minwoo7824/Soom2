...
public class ImagePinch extends FrameLayout {

    public static boolean ZOOM_STATUS = false;

    public ImagePinch(@NonNull Context context) {
        super(context);
    }

    public ImagePinch(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ImagePinch(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void processSingleTouchOutsideMinimap(final MotionEvent ev) {
        ...
        touchLastX = x;
        touchLastY = y;
        Log.i("IMAGE_PINCH","processSingleTouchOutsideMinimap : " + ev.getAction());
    ...
    private void processDoubleTouchEvent(final MotionEvent ev) {
        ...
        Log.i("IMAGE_PINCH","processDoubleTouchEvent : " + ev.getAction());
        Log.i("IMAGE_PINCH","zoom : " + zoom);
