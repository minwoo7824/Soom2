                    ...
                    if (itemLists.get(o).getTitle() != null){
                        if (itemLists.get(o).getTitle().length() != 0) {
                            if (itemLists.get(o).getTitle().contains(year + "-" + month + "-" + day)) {
                                Log.d("itemList", "itemList : " + itemLists.get(o).getEtcItemArrayList().size());
...
//                        Log.d("item List", "(itemList != null) : " + (itemList != null) + "   " + year + "-" + month + "-" + day);
//                        if (itemList != null) {
//                        if (itemList.getTitle() != null) {
//                            Log.d("item List", "(itemList.getTitle() != null) : " + (itemList.getTitle() != null));
