...
public class AdultCheckThirdActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener , CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adult_check_third);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.btn_adult_check_third_next : {
                Intent i = new Intent(this,AdultCheckFourActivity.class);
