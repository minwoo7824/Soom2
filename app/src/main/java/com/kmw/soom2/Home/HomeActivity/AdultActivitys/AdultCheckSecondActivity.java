...
public class AdultCheckSecondActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener , CompoundButton.OnCheckedChangeListener{

    private String TAG = "AdultCheckSecondActivity";
    TextView txtBack;
    RadioGroup rdoGroup;
    Button btnNext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adult_check_second);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.btn_adult_check_second_next : {
                Intent i = new Intent(this,AdultCheckThirdActivity.class);
