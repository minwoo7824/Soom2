...
public class AdultCheckFirstActivity extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener, CompoundButton.OnCheckedChangeListener {

    private String TAG = "AdultCheckFirstActivity";
    TextView txtBack;
    RadioGroup rdoGroup;
    Button btnNext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adult_check_first);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.btn_adult_check_first_next : {
                Intent i = new Intent(this,AdultCheckSecondActivity.class);
                i.putExtra("score",(idxScore + 1));
                i.putExtra("kidsScore",""+(idxScore + 1));
