...
public class AdultCheckFiveActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener , CompoundButton.OnCheckedChangeListener {

    private String TAG = "AdultCheckFiveActivity";
    TextView txtBack;
    RadioGroup rdoGroup;
    Button btnNext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adult_check_five);
    ...
    void FindViewById(){
        txtBack = (TextView)findViewById(R.id.txt_adult_check_five_back);
        rdoGroup = (RadioGroup)findViewById(R.id.rdo_adult_check_five_group);
        btnNext = (Button)findViewById(R.id.btn_adult_check_five_next);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.txt_adult_check_five_back : {
                onBackPressed();
                break;
            }
            case R.id.btn_adult_check_five_next : {
                Intent i = new Intent(this,AdultCheckResultActivity.class);
