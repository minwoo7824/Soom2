...
public class KidsCheckThirdActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener, CompoundButton.OnCheckedChangeListener  {

    private String TAG = "KidsCheckThirdActivity";
    TextView txtBack;
    RadioGroup rdoGroup;
    Button btnNext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kids_check_third);
    ...
    void FindViewById(){
        txtBack = (TextView)findViewById(R.id.txt_adult_check_third_back);
        rdoGroup = (RadioGroup)findViewById(R.id.rdo_adult_check_third_group);
        btnNext = (Button)findViewById(R.id.btn_adult_check_third_next);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.txt_adult_check_third_back : {
                onBackPressed();
                break;
            }
            case R.id.btn_adult_check_third_next : {
                if (idxScore == 0){
                    Toast.makeText(this, "항목을 선택해주세요.", Toast.LENGTH_SHORT).show();
                }else{
                    Intent i = new Intent(this, KidsCheckFourActivity.class);
