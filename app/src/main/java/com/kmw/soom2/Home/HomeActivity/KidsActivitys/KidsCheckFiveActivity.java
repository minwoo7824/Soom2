...
public class KidsCheckFiveActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener, CompoundButton.OnCheckedChangeListener  {

    private String TAG = "KidsCheckFiveActivity";
    TextView txtBack;
    RadioGroup rdoGroup;
    Button btnNext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kids_check_five);
